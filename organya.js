(() => {
    ...
    window.initOrganya = async () => {
        ...
        const res = await fetch(new URL("https://idioticbaka1824.github.io/music/organya-js-03/WAVE100.bin"));
        const buf = await res.arrayBuffer();
        const view = new DataView(buf);
        waveTable = new Int8Array(buf);
        
        // const res_d = await fetch("DrumWaves.bin"); //'_d' for 'drum'. Beyond that, code is unchanged
        const res_d = await fetch(new URL("https://idioticbaka1824.github.io/music/organya-js-03/DrumWaves.bin"));
